    ...
    <div class="teamItem">
      ...
      <el-row class="footer">
        <el-col v-if="teamType !== 0" :span="8">
          <el-button v-show="!isEdit" type="text" @click="edit">编辑</el-button>
          <el-button v-show="isEdit" type="text" @click="comfirm">确认编辑</el-button>
        </el-col>
        <el-col v-if="canRelease" :span="8">
          <el-button type="text" @click="releaseCourt">解除</el-button>
        </el-col>
