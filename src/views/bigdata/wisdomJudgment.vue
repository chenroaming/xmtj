      ...
      <el-col :span="8">
        <el-row class="center-wrapper-top">
          ...
          <el-row style="height:50%">
            <el-col :span="8" style="text-align: center">
              ...
              <label class="dashboard-label"><span style="font-size:16px;color: #fff;">4580件</span><br>当事人申请</label>
            </el-col>
            <el-col :span="8" style="text-align: center;">
              <img style="width: 70%;" src="../../assets/bigData/xm/darkRing.png" alt="">
              <label class="dashboard-label" style="color:#079FE8"><span style="font-size:16px;color: #fff;">3817件</span><br>联动单位</label>
            </el-col>
            <el-col :span="8" style="text-align: center;">
              <img style="width: 70%;" src="../../assets/bigData/xm/linghtRing.png" alt="">
              <label class="dashboard-label"><span style="font-size:16px;color: #fff;">6869件</span><br>人民调解平台</label>
            </el-col>
          </el-row>
        </el-row>
        ...
        <el-row class="center-wrapper-bottom">
          ...
          <el-row style="height:50%">
            <el-col :span="8" style="text-align: center">
              <img style="width: 70%;" src="../../assets/bigData/xm/linghtRing.png" alt="">
              <label class="dashboard-label"><span style="font-size:16px;color: #fff;">4695件</span><br>调解</label>
            </el-col>
            <el-col :span="8" style="text-align: center;">
              <img style="width: 70%;" src="../../assets/bigData/xm/darkRing.png" alt="">
            ...
            <el-col :span="8" style="text-align: center;">
              <img style="width: 70%;" src="../../assets/bigData/xm/linghtRing.png" alt="">
              <label class="dashboard-label"><span style="font-size:16px;color: #fff;">106件</span><br>其他</label>
            </el-col>
          </el-row>
        </el-row>
      </el-col>
...
import { char1 } from '../../api/common/common.js'
export default {
  components: {
    heatmap,
    disputeNum,
  ...
  methods: {
    ...
    getchar1(params) {
      char1(params).then(res => {
        console.log('getchar1', res)
        console.log('getchar111111111', this.data1, this.data2, this.data3, this.data4, this.data5, this.data6, this.data7)
        if (res.state == 100) {
