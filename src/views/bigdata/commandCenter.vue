  ...
  <el-row style="position: relative;">
      ...
      <el-row v-for="(item,index) in localInfo.left" :key="index" :gutter="40" class="local-wrapper" style="position: relative;">
        <el-col v-for="item1 in item" :key="item1.name" :span=" 6" :class="{'active': item1.state == 0}" class="local-item" @click.native="connect(item1.id, item1.name, item1.state)">
          <div :style="{'margin-top':item1.state == 1 ? '45px':'0'}" class="contentBox">
            <div>{{ item1.name }}</div>
            <!-- <div v-if="item1.state == 1 " style="text-align:center;font-size:12px;">35件</div> -->
    ...
    <el-col :span="8" class="center-wrapper">
      <div ref="picBox" class="center-wrapper-top" :style="{height:getHeight + 'px'}">
        <div class="content" :style="{paddingTop:getpadding + 'px'}">
          <p class="text">法院新收案件数</p>
                    <h1 class="num" style="padding-top:15px;padding-bottom:15px;">2.73万件</h1>
                    <p class="text" style="padding-bottom:15px;">数据总量</p>
                    <h1 class="num2">
            <span>同比去年</span>
            <!-- 下降是用绿色的 -->
      ...
      <dv-border-box-8 :reverse="true" class="center-wrapper-bottom">
        ...
        <el-row class="one">
          <el-col :span="6">
            <div class="topThree">
              <div class="contentText">纠纷数</div>
              <div class="contentNum" style="color:#10E3FE">24394</div>
            </div>
          </el-col>
          <el-col :span="6">
            <div class="topThree">
              <div class="contentText">成讼数</div>
              <div class="contentNum" style="color:#10E3FE">19281</div>
            </div>
          </el-col>
          <el-col :span="6">
            <div class="topThree">
              <div class="contentText">诉前调解率</div>
              <div class="contentNum" style="color:#10E3FE">85.16%</div>
            </div>
          </el-col>
          <el-col :span="6">
            <div class="topThree">
              <div class="contentText">委派委托调解成功率</div>
              <div class="contentNum" style="color:#10E3FE">30.69%</div>
            </div>
          </el-col>
        </el-row>
      </dv-border-box-8>
...
.xm-bigdata-wrapper{
  ...
  .center-wrapper {
    ...
    .center-wrapper-bottom {
      ...
      background-size: 100% 100%;
      background-repeat: no-repeat;
      background-image: url('../../assets/bigData/xm/8.png');
      // position: absolute;
      .one{
        height: 50%;
        .contentText{
