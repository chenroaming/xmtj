  ...
  <el-form ref="form" :rules="rules" :model="form" label-width="150px">
    ...
    <el-row>
      <el-col :span="20">
        <el-form-item label="证件号码" prop="agentIdentiCard">
          <el-input v-model="form.agentIdentiCard" type="text" />
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
    ...
    <el-row>
      <el-col v-if="form.agentType == 1" :span="20">
        <el-form-item label="律师证件号" prop="lawerNum">
          <el-input v-model="form.lawerNum" type="text" />
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
    ...
    <el-row>
      <el-col v-if="isShowTextarea" :span="20">
        <el-form-item label="其他委托事项" prop="">
          <el-input v-model="form.otherAuthority" type="text" />
        </el-form-item>
      </el-col>
    </el-row>
  </el-form>
